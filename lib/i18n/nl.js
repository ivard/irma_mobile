export default {
  ...
  Mail: {
    irmasignatureSubject: 'IRMA handtekening',
    irmasignatureBody: 'Zie de bijlage voor een IRMA handtekening.',
    irmabackupSubject:  'IRMA backup',
    irmabackupBody: 'Als je je attributen wilt herstellen, open dan de bijlage van deze mail op je telefoon. Zorg er wel voor dat de IRMA app geïnstalleerd is. De app hoeft verder niet ingesteld te worden.'
  },
  ErrorCard: {
    types: {
