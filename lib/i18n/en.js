export default {
  ...
  ChangePin: {
    ...
    pinError: 'The current PIN was incorrect. You have {{attempts}} left before your account will be temporarily blocked.',
  ...
  Mail: {
    irmasignatureSubject: 'IRMA signature response',
    irmasignatureBody: 'See the attachment for an IRMA signature.',
    irmabackupSubject:  'IRMA backup',
    irmabackupBody: 'When you want to restore your IRMA attributes, open the attachment on your phone. Make sure the IRMA app is installed. You don\'t have to set-up anything in the app at first.',
  },
  ErrorCard: {
    types: {
