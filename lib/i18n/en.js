export default {
  ...
  Mail: {
    ...
    irmabackupBody: 'When you want to restore your IRMA attributes, open the attachment on your phone. Make sure the ' +
      'IRMA app is installed. You don\'t have to set-up anything in the app at first.',
  },
  ErrorCard: {
    types: {
